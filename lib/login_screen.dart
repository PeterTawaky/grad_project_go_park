                ...
                builder: (context, state) {
                  if (state is GoogleSignInLoading ||
                    ...
                    return LoggingWidget(
                      loggingMessage: AppStrings.signInLogging,
                    );
                  } else {
                    return Column(
                                ...
                                children: [
                                  ...
                                  >(
                                    buildWhen:
                                        (previous, current) =>
                                            current
                                                is ResetPasswordMailSentLoading ||
                                            current
                                                is ResetPasswordMailSentSuccess ||
                                            current
                                                is ResetPasswordMailSentFailed,
                                    listener: (context, state) {
                                      if (state
                                          is ResetPasswordMailSentSuccess) {
                                        HelperFunctions.showSnackBar(
                                      ...
                                      if (state
                                        ...
                                        return TextButton(
                                          ...
                                          child: Text(
                                            ...
                                            style:
                                                TextStyles.font12regularPurple,
                                          ),
                                        );
                                      }
                                    },
                                ...
                                builder: (context, state) {
                                  if (state is AuthenticationLoading) {
                                    return CustomButtonForAction(
                                      ...
                                      backgroundColor:
                                          ColorsManager.authScreenPurple,
                                      outlineColor:
                                          ColorsManager.authScreenPurple,
                                    );
                                  } else {
